...
def main():
    ...
    parser.add_argument(
        "--coco-anno",
        default="C:/dataset/BB-object365-train-v221002/objects365_train.json",
        help="path to coco annotation file",
        # required=True
    )
    parser.add_argument(
        "--coco-image-dir",
        default="D:/dataset/object365/train",
        help="path to coco image dir",
    )
    parser.add_argument(
        "--output-dir",
        default="C:/dataset/BB-object365-train-v221002",
    ...
    img_ids = [img_info['id'] for img_info in json_dict['images']]
    img_ids_annos = {}
    for img_id in img_ids:
        img_ids_annos[img_id] = []

    for anno in json_dict['annotations']:
        img_ids_annos[anno['image_id']].append(anno)
    ...
    for img_info in tqdm(json_dict['images']):
        ...
        img_annos = img_ids_annos[img_id]
        """
        for anno in json_dict['annotations']:
        ...
        assert os.path.exists(os.path.join(args.coco_image_dir, img_name))
